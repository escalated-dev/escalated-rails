module Escalated
  module Agent
    class TicketsController < Escalated::ApplicationController
      ...
      before_action :set_ticket, only: [:show, :update, :reply, :note, :assign, :status, :priority, :tags, :department]
      ...
      def index
        ...
        render inertia: "Escalated/Agent/Tickets/Index", props: {
      ...
      def show
        ...
        render inertia: "Escalated/Agent/Tickets/Show", props: {
