...
require 'escalated/support/json_query'
require 'escalated/support/import_context'
require 'escalated/support/outbound_url'
require 'escalated/support/cloud_vocabulary'
...
module Escalated
  class << self
    ...
    # rubocop:disable-next Rails/Delegate -- `delegate :driver, to: :Manager` calls #Manager on the singleton class, not Escalated::Manager.
    def driver
      Manager.driver
    end
